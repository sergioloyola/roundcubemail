...
*/
function rcube_mail_ui(){function f(a){p||(p=rcmail.local_storage_get_item("prefs.kion",{}));if(null==p[a]){var d=rcmail.get_cookie(a);null!=d&&(p[a]=d,rcmail.local_storage_set_item("prefs.kion",p)&&rcmail.set_cookie(a,d,new Date))}return p[a]}function q(a,d){p[a]=d;if(!rcmail.local_storage_set_item("prefs.kion",p)){var c=new Date;c.setYear(c.getFullYear()+1);rcmail.set_cookie(a,d,c)}}function s(a){a=a?10:0;rcmail.resize_timeout&&window.clearTimeout(rcmail.resize_timeout);rcmail.resize_timeout=
...
$("div.addline",b).remove()},width:480}).show())}function J(a){a=$(this).parent();a=a.clone().addClass("addline").insertAfter(a);a.children(".iconlink").click(J);a.children("input").val("");document.all||$("input[type=file]",a).click()}function z(a,b){var c=$("#compose-"+a);if(!c.is(":visible"))return C[a]&&!b&&$("#_"+a).val(C[a]),c.show(),$("#"+a+"-link").hide(),t(),$("input,textarea",c).focus(),!1}function K(a,b){var c=$(a),e=c.get(0).id,g=c.children("fieldset");if(g.length){e||(e="rcmtabcontainer",
...
a.type||13==rcube_event.get_keycode(a))return N(this,a),!1}))}),"1"==f("previewheaders")&&H();else if("compose"==rcmail.env.action){rcmail.addEventListener("aftersend-attachment",y).addEventListener("add-recipient",function(a){z(a.field,!0)}).addEventListener("aftertoggle-editor",function(a){window.setTimeout(function(){t()},200);a&&a.mode&&$("select[name='editorSelector']").val(a.mode)});for(var d,c,D=["cc","bcc","replyto","followupto"],a=0;a<D.length;a++)d=D[a],c=$("#_"+d),c.length&&(c.on("change",
{v:d},function(a){this.value&&z(a.data.v,!0)}),""!=c.val()&&z(d,!0));$("#composeoptionstoggle").click(function(a){var b=$("#composeoptions").toggle().is(":visible");$("#composeoptionstoggle").toggleClass("remove").attr("aria-expanded",b?"true":"false");t();q("composeoptions",b?"1":"0");rcube_event.is_keyboard(a)||this.blur();return!1}).css("cursor","pointer");"0"!==f("composeoptions")&&$("#composeoptionstoggle").click();$("textarea[name='_to'], textarea[name='_cc'], textarea[name='_bcc']").change(function(a){E(this)}).change();
rcmail.addEventListener("autocomplete_insert",function(a){E(a.field)});(a=rcmail.opener())&&"compose"==a.env.action&&$("#composeoptionstoggle",opener.document).hasClass("remove")&&$("#composeoptionstoggle").click();(new rcube_splitter({id:"composesplitterv",p1:"#composeview-left",p2:"#composeview-right",orientation:"v",relative:!0,start:206,min:170,size:12,render:t})).init()}else"list"!=rcmail.env.action&&rcmail.env.action?"get"==rcmail.env.action&&(new rcube_splitter({id:"mailpartsplitterv",p1:"#messagepartheader",
...
(buttons[supportln.html()]=function(a){0>r.supporturl.indexOf("mailto:")?window.open(r.supporturl):location.href=r.supporturl});b.dialog({modal:!0,resizable:!1,closeOnEscape:!0,title:a?a.title||a.innerHTML:null,close:function(){b.dialog("destroy").remove()},buttons:buttons,width:640,height:h}).width(640)};this.show_popup=function(a,b,c){!c&&u[a]||B(a,c);c=u[a]||{};c=$(c.link?c.link:"#"+a+"link");var e=c.offset();c.has(".inner")&&(c=c.children(".inner"));return rcmail.command("menu-open",{menu:a,show:b},
c.get(0),$.Event("click",{target:c.get(0),pageX:e.left,pageY:e.top,clientX:e.left,clientY:e.top}))};this.toggle_popup=function(a,b,c){!c&&u[a]||B(a,c);return rcmail.command("menu-open",a,b.target,b)};this.add_popup=B;this.set_searchmod=function(a){var b,c;b=rcmail.env.task;var e=rcmail.env.search_mods,g=rcmail.env.mailbox;"all"==$('input[name="s_scope"]:checked').val()&&(g="*");e||(e={});"mail"==b?(e[g]||(e[g]=rcube_clone_object(e["*"])),c=e[g],b="text"):(c=e,b="*");a.checked?c[a.value]=1:delete c[a.value];
a.value==b&&$('input:checkbox[name="s_mods[]"]').map(function(){this!=a&&(this.checked=!0,a.checked?(this.disabled=!0,delete c[this.value]):(this.disabled=!1,c[this.value]=1))});rcmail.set_searchmods(c)};this.set_searchscope=function(a){rcmail.set_searchscope(a.value)};this.show_uploadform=y;this.show_header_row=z;this.hide_header_row=function(a){var b=$("#_"+a);C[a]=b.val();b.val("");$("#compose-"+a).hide();$("#"+a+"-link").show();t();return!1};this.update_quota=A;this.get_pref=f;this.save_pref=
